...
<head>
  ...
  <title>分配群组存储空间</title>
  <meta name="dcescription" content="这是一个 table 页面">
...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">存储空间-${space.spaceName }</strong> / <small>分配</small></div>
  	</div>
    <div class="am-g">
		<div class="am-g">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
	   	$.get("${ctx}/admin/group/getGroupInfosBySpaceId?spaceId=${space.id}",function(data){ 
	    ...
	    $("#savebt").click(function(){
	    	...
	    	$.ajax({
	    		type: "POST",
                url: "${ctx}/admin/group/distributeSpace",
                data : {
    ...
    function getCheckedNodes(){
        ...
        document.getElementById('groupIds').value=v;
    }
